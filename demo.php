...
//
//define('APPKEY','yWxlnuyziS9zjZOB84uQx5');
//define('APPID','ITEcYltG0n9n4CTU93dU78');
//define('MASTERSECRET','ZYosi7lhhp9YqjFN5k9C5');
...
define('APPKEY','yWxlnuyziS9zjZOB84uQx5');
define('APPID','lTEcYItG0n9n4CTU93dU78');
define('MASTERSECRET','ZYosi7Ihhp9YqjFNF5k9C5');
define('CID','39392a0a479e4a5cfcfd7d7ff29d41e7');
define('DEVICETOKEN','');
define('Alias','阿捷');
...
function IGtNotificationTemplateDemo(){
    ...
    $template->set_transmissionContent("不要i");//透传内容
...
function IGtTransmissionTemplateDemo(){
    ...
    $template->set_appkey(APPKEY);//应用appkey
    $template->set_transmissionType(1);//透传消息类型
    $template->set_transmissionContent("sadsad ");//透传内容
    //$template->set_duration(BEGINTIME,ENDTIME); //设置ANDROID客户端在此时间区间内展示消息
    //APN简单推送
